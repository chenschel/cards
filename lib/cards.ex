defmodule Cards do
  ...
  @doc """
    Devides a deck into a hand the remainder of the deck.
    The `hand_size` argument indecates how many cards should be in the hand.
